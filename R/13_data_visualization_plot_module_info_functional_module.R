...
#
# plot <-
#   plot_module_info(object = functional_module_annotation,
#                    level = "functional_module",
#                    llm_text = TRUE,
#                    module_id = "Functional_module_6")
#
...
#                    )
# plot <-
#   plot_module_info(object = llm_interpreted_functional_module,
...
#' Plot Module Information for a \code{functional_module} Object
#'
#' Internal implementation called by [plot_module_info.functional_module()].
#' Generates a network plot, bar plot, and word cloud for a single module.
#'
#' @param object A \code{functional_module} S4 object.
#' @param level Character. \code{"module"} or \code{"functional_module"}.
#' @param database Character. Source database: \code{"go"}, \code{"kegg"},
#'   \code{"reactome"}, \code{"hmdb"}, or \code{"metkegg"}. Required when
#'   \code{level = "module"}.
#' @param database_color Named character vector of colours for each database.
#' @param module_id Character. A single module ID to visualise.
#' @param llm_text Logical. Use LLM-generated module names. Default \code{FALSE}.
#'
#' @return A named list of three \code{ggplot} objects: \code{network},
#'   \code{barplot}, and \code{wordcloud}.
#'
#' @noRd
